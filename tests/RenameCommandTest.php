...
class RenameCommandTest extends TestCase
{
    public function testRenameAKeyValue()
    {
        ...
        $this->artisan('laralang:rename', ['oldKey' => 'user.mobile', 'newKey' => 'contact']);

        $newValue = (array) include $this->app['config']['laralang.path'].'/en/user.php';
    ...
    public function testRenameAKeyValueForAllLanguages()
    {
        ...
        $newValueEN = (array) include $this->app['config']['laralang.path'].'/en/user.php';
        $newValueES = (array) include $this->app['config']['laralang.path'].'/es/user.php';
    ...
    public function testRenameANestedKeyValueForAllLanguages()
    {
        ...
        $this->artisan('laralang:rename', ['oldKey' => 'user.contact.cellphone', 'newKey' => 'mobile']);
    ...
    public function testRenameOfANestedKeyValueForAllLanguagesInAnyDepth()
    {
        ...
        $this->artisan('laralang:rename', ['oldKey' => 'user.contact.others.msn', 'newKey' => 'mail']);
    ...
    public function testRenameCommandShowViewFilesAffectedForTheChange()
    {
        ...
        $this->artisan('laralang:rename', ['oldKey' => 'users.name', 'newKey' => 'username']);
