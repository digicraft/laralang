...
class MissingCommandTest extends TestCase
{
    public function testCommandOutput()
    {
        ...
        $command = m::mock('\Digicraft\Laralang\Commands\MissingCommand[ask]', [$manager]);
        ...
        $this->artisan('laralang:missing');

        $missingENFile = (array) include $this->app['config']['laralang.path'].'/en/missing.php';
        $missingNLFile = (array) include $this->app['config']['laralang.path'].'/nl/missing.php';
        $userNlFile = (array) include $this->app['config']['laralang.path'].'/nl/user.php';
        $productENFile = (array) include $this->app['config']['laralang.path'].'/en/product.php';
        $productNlFile = (array) include $this->app['config']['laralang.path'].'/nl/product.php';
    ...
    public function testAllowSeeTranslationInDefaultLanguage()
    {
        ...
        $this->artisan('laralang:missing', ['--default' => true]);
    }
