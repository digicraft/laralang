...
class ManagerTest extends TestCase
{
    ...
    {
        $manager = $this->app[\Digicraft\Laralang\Manager::class];
...
//            ],
    ...
    public function testCreateFileIfNotExisting()
    {
        ...
        $this->assertFileExists($this->app['config']['laralang.path'].'/en/user.php');
        $this->assertFileExists($this->app['config']['laralang.path'].'/sp/user.php');
        $this->assertEquals('__UN_TOUCHED__', file_get_contents($this->app['config']['laralang.path'].'/nl/user.php'));
        $this->assertEquals([], (array) include $this->app['config']['laralang.path'].'/en/user.php');
    }
    ...
    public function testWriteFile()
    {
        ...
        $filePath = $this->app['config']['laralang.path'].'/en/user.php';
    ...
    public function testGetFileContentReadsContent()
    {
        ...
        $filePath = $this->app['config']['laralang.path'].'/en/users.php';
    ...
    {
        $manager = m::mock('Digicraft\Laralang\Manager[languages]', [new Filesystem(), '', []]);
